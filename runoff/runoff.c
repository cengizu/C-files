...
bool vote(int voter, int rank, string name)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        {
            // Populate preferences with voter ranks (i is the candidate)
...
{
    // TODO
    // Check if any candidate has the majority of the votes
...
{
    // TODO
    // Min votes = first candidates votes
    int min_votes = candidates[0].votes;

    // If a candidate has less votes, update min votes
    for (int i = 0; i < candidate_count; i++)
    {
